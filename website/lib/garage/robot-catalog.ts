...
export const ROBOT_TYPES: RobotType[] = [
  // ═══ DRONES ═══════════════════════════════════════════════════════════════
  {
    ...
    hardwareModels: [
      ...
      hw("agilicious", {
        name: "Agilicious",
        manufacturer: "UZH / Open Source (Science Robotics)",
        desc: "Open-source and open-hardware agile quadrotor for vision-based flight. Published in Science Robotics. Designed for high-speed autonomous racing and agile flight research with full sim-to-real pipeline.",
        specs: { flightTime: "~5 min agile", compute: "Jetson", sensors: "VIO camera", license: "Open source", paper: "Sci. Robot 2022" },
        price: "~$3,000–6,000 (DIY)",
        ros: "ros2",
        locomotion: "quadrotor",
        weightKg: 0.8,
        payloadKg: 0.3,
  ...
  // ═══ WHEELED ROBOTS ═══════════════════════════════════════════════════════
  {
    ...
    hardwareModels: [
      ...
      hw("openscout", {
        name: "OpenScout",
        manufacturer: "Open Source (Journal of Open Hardware)",
        desc: "Fully open-source mobile robot published in the Journal of Open Hardware. Differential drive, modular sensor mounts, complete CAD + BOM + assembly guide. Designed for reproducible research.",
        specs: { drive: "differential", compute: "RPi / Jetson", license: "Open source", journal: "JOH 2023" },
        price: "~$1,500–3,000 (DIY)",
        ros: "ros2",
        locomotion: "differential",
        weightKg: 5,
        payloadKg: 5,
      ...
      hw("oomwoo-vacuum", {
        ...
        manufacturer: "Open Source / MakersPet",
        desc: "Open-source robot vacuum you build yourself. Differential drive, LIDAR-based SLAM, ROS-compatible. A low-cost entry into domestic robotics and mapping research.",
        specs: { drive: "differential", sensors: "LiDAR + bump", compute: "ESP32 + RPi", license: "Open source" },
        price: "~$300–600 (DIY)",
        ros: "both",
        locomotion: "differential",
        weightKg: 2,
        payloadKg: 0,
        supportedProducts: ["build", "frame", "view", "autonomy", "data"],
      }),
    ],
  },
  {
  ...
  },
  {
    ...
    hardwareModels: [
      ...
      hw("openpodcar", {
        name: "OpenPodcar",
        manufacturer: "Open Source (Journal of Open Hardware)",
        desc: "Open-source vehicle for self-driving car research. Published in JOH with full CAD, BOM, and a ROS 2 autonomy stack. A low-cost, reproducible platform for autonomous driving research.",
        specs: { drive: "ackermann", compute: "RPi / Jetson", license: "Open source", journal: "JOH 2023" },
        price: "~$2,500–5,000 (DIY)",
        ros: "ros2",
        locomotion: "ackermann",
        weightKg: 15,
        payloadKg: 10,
  ...
  // ═══ LEGGED ROBOTS ════════════════════════════════════════════════════════
  {
    ...
    hardwareModels: [
      ...
      // ── OPEN-SOURCE QUADRUPEDS ──────────────────────────────────────────────
      hw("solo12", {
        name: "Solo12 (ODRI)",
        manufacturer: "Open Dynamic Robot Initiative / Open Source",
        desc: "Fully open-source 12-DOF quadruped from the Open Dynamic Robot Initiative. Torque-controlled, BLDC-driven, 2.5 kg, designed for legged locomotion research. Complete CAD + firmware + Python controller.",
        specs: { dof: "12", weight: "2.5 kg", drive: "BLDC + ODrive", license: "BSD-3", paper: "IEEE RA-L 2020" },
        price: "~$5,000–10,000 (DIY)",
        ros: "ros2",
        locomotion: "quadruped",
        weightKg: 2.5,
        payloadKg: 1,
        supportedProducts: ["build", "frame", "serve", "view", "pilot", "data", "train"],
      }),
      hw("openquadruped", {
        name: "OpenQuadruped",
        manufacturer: "Open Source / Community",
        desc: "Community-driven open-source quadruped. 3D-printable frame, 12-DOF servo-driven, ROS 2-compatible. Designed as an affordable alternative to commercial quadrupeds for education and research.",
        specs: { dof: "12", servos: "BLDC / smart servo", material: "3D-printed", license: "Open source" },
        price: "~$2,000–4,000 (DIY)",
        ros: "ros2",
        locomotion: "quadruped",
        weightKg: 4,
        payloadKg: 1.5,
  ...
  // ═══ HUMANOID ROBOTS ══════════════════════════════════════════════════════
  {
    ...
    hardwareModels: [
      ...
      hw("asimov-1", {
        name: "Asimov 1",
        manufacturer: "Open Source / DIY",
        desc: "Fully open-source humanoid DIY kit with a ~$15K target bill of materials. Complete hardware designs, firmware, and ROS 2 stack. A community-driven full-size humanoid.",
        specs: { dof: "28+", height: "~150 cm", license: "Open source", stack: "ROS 2" },
        price: "~$15,000 (target DIY BOM)",
        ros: "ros2",
        locomotion: "bipedal",
        weightKg: 40,
        payloadKg: 3,
      ...
      hw("berkeley-humanoid-lite", {
        name: "Berkeley Humanoid Lite",
        manufacturer: "UC Berkeley / Open Source",
        desc: "Sub-$5K fully open-source 3D-printed humanoid. Published as an arXiv paper with complete CAD, firmware, and a sim-to-real RL training pipeline. Designed for accessible humanoid research.",
        specs: { dof: "16", height: "~80 cm", material: "3D-printed", license: "Open source", paper: "arXiv:2504.17249" },
        price: "~$3,000–5,000 (DIY)",
        ros: "ros2",
        locomotion: "bipedal",
        weightKg: 5,
        payloadKg: 1,
        hasArm: true,
        supportedProducts: ["build", "frame", "bench", "serve", "view", "autonomy", "pilot", "data", "train"],
      }),
      hw("hopejr", {
        name: "HopeJR",
        manufacturer: "Hugging Face / Open Source",
        desc: "Fully open-source ~$3K humanoid from Hugging Face's LeRobot team. 3D-printable, Feetech-servo driven, designed for community-driven imitation-learning research.",
        specs: { dof: "20+", height: "~70 cm", servos: "Feetech STS3215", license: "Apache-2.0", ecosystem: "LeRobot" },
        price: "~$3,000 (DIY)",
        ros: "ros2",
        locomotion: "bipedal",
        weightKg: 4,
      ...
      hw("robotis-k0", {
        name: "ROBOTIS K0",
        manufacturer: "ROBOTIS / Open Source",
        desc: "Full-size open-source humanoid platform from ROBOTIS. Dynamixel-driven, designed as an open reference for full-scale humanoid research and education.",
        specs: { dof: "—", height: "Full-size", servos: "Dynamixel", license: "Open source" },
        price: "TBA",
        ros: "ros2",
        locomotion: "bipedal",
        weightKg: 30,
      ...
      hw("vibe-a1", {
        name: "Vibe A1",
        manufacturer: "Vibe Robotics / Open Source",
        desc: "Mini open-source humanoid with a starting price of $649. Compact, affordable, community-driven — designed to make humanoid robotics accessible to makers and educators.",
        specs: { dof: "16", height: "~40 cm", license: "Open source", price: "from $649" },
        price: "~$649+",
        ros: "ros2",
        locomotion: "bipedal",
        weightKg: 1.5,
      ...
      hw("icub", {
        name: "iCub",
        manufacturer: "IIT / Open Source",
        desc: "The classic open-source humanoid research platform from the Italian Institute of Technology. 104 cm tall, 22 kg, 53-DOF. Used in 50+ labs worldwide for cognitive robotics.",
        specs: { dof: "53", height: "104 cm", weight: "22 kg", license: "GPL/CeCILL", middleware: "YARP + ROS 2" },
        price: "Research collaboration",
        ros: "both",
        locomotion: "bipedal",
        weightKg: 22,
        payloadKg: 1.5,
        hasArm: true,
        supportedProducts: ["serve", "view", "pilot", "data", "train"],
      }),
      hw("poppy-humanoid", {
        name: "Poppy Humanoid",
        manufacturer: "Inria / Open Source",
        desc: "Open-source 3D-printed humanoid for science, education and art. 25-DOF, modular, designed for experimentation and reproducible research in embodied AI.",
        specs: { dof: "25", height: "84 cm", material: "3D-printed", license: "GPL", middleware: "Pypot + ROS" },
        price: "~$8,000–12,000 (DIY)",
        ros: "both",
        locomotion: "bipedal",
        weightKg: 3.5,
        payloadKg: 0.5,
        hasArm: true,
        supportedProducts: ["build", "serve", "view", "pilot", "data", "train"],
      }),
    ],
  },
  ...
  // ═══ MARINE ROBOTS ════════════════════════════════════════════════════════
  {
    ...
    hardwareModels: [
      ...
      hw("openfish", {
        name: "OpenFish",
        manufacturer: "Open Source (HardwareX)",
        desc: "Open-source biomimetic soft robotic fish for high-speed underwater locomotion. Published in HardwareX with full CAD, modeling, and control. Designed for marine research and bio-inspired propulsion studies.",
        specs: { type: "biomimetic soft fish", drive: "servo + soft body", license: "Open source", journal: "HardwareX 2022" },
        price: "~$1,000–3,000 (DIY)",
        ros: "custom",
        locomotion: "marine-fin",
        weightKg: 1.5,
        payloadKg: 0.2,
        supportedProducts: ["build", "view", "pilot", "data"],
      }),
    ],
  },
  ...
  // ═══ INDUSTRIAL ARMS ══════════════════════════════════════════════════════
  {
    ...
    hardwareModels: [
      ...
      hw("so100-arm", {
        name: "SO-100 (LeRobot)",
        manufacturer: "LeRobot / Open Source",
        desc: "The predecessor to SO-101 — a fully open-source 6-DOF 3D-printed arm with STS3215 servos. The arm that popularized low-cost imitation learning. Compatible with the LeRobot training pipeline.",
        specs: { dof: "6", payload: "0.5 kg", reach: "0.5 m", servos: "STS3215 ×6", license: "Apache-2.0" },
        price: "~$300",
        ros: "ros2",
        locomotion: "fixed-base",
        weightKg: 0.9,
      ...
      hw("para-arm", {
        name: "PARA Arm",
        manufacturer: "Open Source (HardwareX)",
        desc: "Open-source 3-DOF robotic arm with 1 m reach and 2 kg payload. Published in HardwareX with full CAD, BOM, and a customizable end effector. Designed for research and education.",
        specs: { dof: "3", payload: "2 kg", reach: "1000 mm", license: "Open source", journal: "HardwareX" },
        price: "~$1,500 (DIY)",
        ros: "ros2",
        locomotion: "fixed-base",
        weightKg: 6,
      ...
      hw("thor-arm", {
        ...
        desc: "Open-source multi-DOF articulated robotic arm for education and autonomous manipulation. Full STL files, control code, and a ROS-compatible driver. Community-maintained.",
        specs: { dof: "6+", material: "3D-printed", license: "Open source", control: "Arduino + ROS" },
        price: "~$800 (DIY)",
        ros: "both",
        locomotion: "fixed-base",
        weightKg: 3,
        payloadKg: 0.5,
        hasArm: true,
        supportedProducts: ["build", "serve", "pilot", "data", "train"],
      }),
      hw("ar4-arm", {
        name: "Annin AR4",
        manufacturer: "Annin Robotics / Open Source",
        desc: "Open-source 6-DOF industrial-style robot arm. 600 mm reach, 0.5 kg payload, stepper-driven. One of the most popular open-source arm designs, with an active community.",
        specs: { dof: "6", payload: "0.5 kg", reach: "600 mm", drive: "NEMA17 steppers", license: "Open source" },
        price: "~$1,000–2,500 (DIY)",
        ros: "both",
        locomotion: "fixed-base",
        weightKg: 4,
        payloadKg: 0.5,
      ...
      hw("kaede-arm", {
        name: "Kaede Arm",
        manufacturer: "Open Source",
        desc: "Open-source low-cost 6-DOF desktop arm for manipulation research. 3D-printable, BLDC-driven, designed for sim-to-real reinforcement learning experiments.",
        specs: { dof: "6", payload: "0.3 kg", drive: "BLDC", material: "3D-printed", license: "Open source" },
        price: "~$1,200 (DIY)",
        ros: "ros2",
        locomotion: "fixed-base",
        weightKg: 1.5,
  ...
  // ═══ SWARM ROBOTS ═════════════════════════════════════════════════════════
  {
    ...
    hardwareModels: [
      ...
      hw("heroswarm", {
        name: "HeRoSwarm",
        manufacturer: "Open Source (IEEE SII 2023)",
        desc: "Fully-capable miniature swarm robot with open-source ROS support. Published at IEEE/SICE SII. Designed for distributed multi-robot research with full hardware designs and firmware.",
        specs: { sensors: "IR + IMU + ToF", compute: "ESP32", comm: "WiFi mesh", license: "Open source", paper: "IEEE SII 2023" },
        price: "~$250–500/unit (DIY)",
        ros: "ros2",
        locomotion: "differential",
        weightKg: 0.25,
        payloadKg: 0.05,
  ...
  // ═══ AGRICULTURAL ROBOTS ══════════════════════════════════════════════════
  {
    ...
    hardwareModels: [
      ...
      hw("openmower", {
        name: "OpenMower",
        manufacturer: "Open Source / Community",
        desc: "Open-source robotic lawn mower. GPS-guided, ROS-compatible, 3D-printable parts. Turns any ride-on or push mower into an autonomous robot. A flagship open-source agricultural project.",
        specs: { drive: "differential / ride-on", nav: "RTK GPS + IMU", license: "Open source", repo: "github.com/ClemensElflein/OpenMower" },
        price: "~$800–3,000 (DIY)",
        ros: "both",
        locomotion: "differential",
        weightKg: 25,
        payloadKg: 0,
        supportedProducts: ["build", "frame", "view", "autonomy", "data", "fleet"],
      }),
    ],
  },
  ...
  // ═══ UNDERWATER ROVs ══════════════════════════════════════════════════════
  {
    ...
    hardwareModels: [
      ...
      hw("openrov", {
        name: "OpenROV / Community ROV",
        manufacturer: "Open Source / Community",
        desc: "Open-source underwater ROV with a thriving community behind it. 3D-printable frame, ESC-driven thrusters, HD camera. The original low-cost underwater robotics platform for explorers and educators.",
        specs: { depth: "75–100 m", thrusters: "ESCs ×3-6", camera: "HD", material: "3D-printed + AL tube", license: "Open source" },
        price: "~$1,000–3,000 (DIY)",
        ros: "custom",
        locomotion: "underwater-6thruster",
        weightKg: 5,
        payloadKg: 1,
        supportedProducts: ["build", "frame", "view", "pilot", "data"],
      }),
    ],
  },
