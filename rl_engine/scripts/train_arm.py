...
try:
    ...
    parser = argparse.ArgumentParser(
        description="Train OmniBot arm policy with Isaac Lab"
    )
    ...
    print(
        "ERROR: Isaac Lab not found. Install from https://isaac-sim.github.io/IsaacLab/"
    )
    sys.exit(1)
...
def main():
    ...
    runner = OnPolicyRunner(
        env,
        {
            "runner": runner_cfg.__dict__,
            "policy": actor_critic_cfg,
            "algorithm": alg_cfg,
        },
        log_dir=os.path.expanduser(args.log_dir),
