...
{
    internal static class AgentBridgeTelemetryConstants
    {
        internal static class FalcoEventName
        {
            public const string PromptSent = "agent_bridge_prompt_sent";
            public const string PromptCompleted = "agent_bridge_prompt_completed";
        }
