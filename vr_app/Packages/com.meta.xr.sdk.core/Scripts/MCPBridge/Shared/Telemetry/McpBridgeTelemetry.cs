...
{
    internal static class McpBridgeTelemetry
    {
        /// <summary>
        /// Extension method to add standard MCPBridge context to events
        /// </summary>
        public static UnifiedEventData AddMcpBridgeContext(
            ...
            bool isEssential = false)
        {
            try
            {
                ...
                unifiedEvent.AddMcpBridgeContext();
