...
> Status: **Phase 0a–0c + Phase 2–4 implemented** (platform contract, app shell, garage sync, glass UI + passthrough, profile-driven teleop, generalized drive + manipulation, WebRTC video, profile-driven recording, robot-side IK) · polish is next
