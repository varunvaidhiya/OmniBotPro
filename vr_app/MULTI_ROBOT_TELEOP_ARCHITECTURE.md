...
> Status: **Phase 0a–0c + Phase 2–5 implemented** (full multi-robot VR teleop stack: platform contract, app shell, garage sync, glass UI + passthrough, profile-driven teleop, generalized drive + manipulation, WebRTC video, profile-driven recording, robot-side IK, per-robot calibration, quick-resume, onboarding, tests)
