...
def generate_launch_description():
    ...
    declare_nav_policy = DeclareLaunchArgument(
        "nav_policy", default_value="~/models/omnibot_nav_policy.onnx",
        description="Path to RL nav ONNX policy")
    declare_arm_policy = DeclareLaunchArgument(
        "arm_policy", default_value="~/models/omnibot_arm_policy.onnx",
    ...
    return LaunchDescription([
        # Arguments
        declare_use_vla, declare_use_smolvla, declare_use_rl, declare_use_langchain,
        declare_vla_model, declare_smolvla_checkpoint, declare_device,
        declare_nav_policy, declare_arm_policy,
