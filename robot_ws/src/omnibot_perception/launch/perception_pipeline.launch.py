...
def _make_nodes(context, *args, **kwargs):
    ...
    use_trigger = LaunchConfiguration('use_vla_trigger').perform(context).lower() == 'true'
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('det_model', default_value='yolov8n.pt',
        ...
        DeclareLaunchArgument('simulate_us', default_value='false',
                              description='Simulate ultrasonic readings'),
        DeclareLaunchArgument('auto_vla', default_value='false',
                              description='Auto-activate VLA on tracking loss'),
        DeclareLaunchArgument('use_vla_trigger', default_value='true',
